...
static int sipt_set_bci_1(struct sip_msg *msg, char *_charge_indicator,
		char *_called_status, char *_called_category, char *_e2e_indicator);
...
static int sipt_destination2(struct sip_msg *msg, char *_destination,
		char *_hops, char *_nai, char *_terminator);
...
static int sipt_get_hop_counter(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_event_info(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_cpc(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_calling_party_nai(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_calling_party(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_presentation(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_screening(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_called_party_nai(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_called_party(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_charge_indicator(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);

static int sipt_get_redirection_info(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_redirection_number_nai(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_redirection_number(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);

static int sipt_get_redirection_reason(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_original_redirection_reason(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_redirecting_number_nai(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_redirecting_number(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_original_called_number_nai(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_original_called_number(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
static int sipt_get_generic_number_nai(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res);
...
static sipt_header_map_t sipt_header_mapping[] = {
		{"CALLING_PARTY_CATEGORY", ISUP_PARM_CALLING_PARTY_CAT, {{NULL, 0}}},
		{"CPC", ISUP_PARM_CALLING_PARTY_CAT, {{NULL, 0}}},
		{"CALLING_PARTY_NUMBER", ISUP_PARM_CALLING_PARTY_NUM,
				{{"NATURE_OF_ADDRESS", 1}, {"NAI", 1}, {"SCREENING", 2},
						{"PRESENTATION", 3}, {NULL, 0}}},
		{"CALLED_PARTY_NUMBER", ISUP_PARM_CALLED_PARTY_NUM,
				{{"NATURE_OF_ADDRESS", 1}, {"NAI", 1}, {NULL, 0}}},
		{"HOP_COUNTER", ISUP_PARM_HOP_COUNTER, {{NULL, 0}}},
		{"EVENT_INFO", ISUP_PARM_EVENT_INFO, {{NULL, 0}}},
		{"BACKWARD_CALL_INDICATOR", ISUP_PARM_BACKWARD_CALL_IND,
				{{"CHARGE_INDICATOR", 1}, {NULL, 0}}},
		{"REDIRECTION_INFO", ISUP_PARM_DIVERSION_INFORMATION, {{NULL, 0}}},
		{"REDIRECTION_NUMBER", ISUP_PARM_REDIRECTION_NUMBER,
				{{"NATURE_OF_ADDRESS", 1}, {"NAI", 1}, {NULL, 0}}},
		{"REDIRECTION_INFORMATION", ISUP_PARM_REDIRECTION_INFO,
				{{"REASON", 1}, {"ORIGINAL_REASON", 2}, {NULL, 0}}},
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_hop_counter((unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_event_info((unsigned char *)body.s, body.len));
	return 0;
}
...
static int sipt_get_cpc(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(
			msg, param, res, isup_get_cpc((unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_calling_party_nai((unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_redirection_info((unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_redirection_number_nai((unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_redirection_reason((unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_original_redirection_reason(
					(unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_redirecting_number_nai((unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_original_called_number_nai(
					(unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	isup_get_original_called_number(
			(unsigned char *)body.s, body.len, sb_s_buf);
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_generic_number_nai((unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_presentation((unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_screening((unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_charging_indicator((unsigned char *)body.s, body.len));
	return 0;
}
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	pv_get_sintval(msg, param, res,
			isup_get_called_party_nai((unsigned char *)body.s, body.len));
	return 0;
}
...
parse_parameters:
	...
	for(i = 0; sipt_header_mapping[i].name != NULL; i++) {
		if(strncasecmp(pvtype.s, sipt_header_mapping[i].name, pvtype.len)
				== 0) {
			...
			for(j = 0; sipt_header_mapping[i].subtypes[j].name != NULL; j++) {
				if(strncasecmp(pvsubtype.s,
						   sipt_header_mapping[i].subtypes[j].name,
						   pvsubtype.len)
						== 0)
		...
		case ISUP_PARM_REDIRECTION_INFO:
			switch(spv->sub_type) {
				...
				case 2: /* ORIGINAL_REASON */
					return sipt_get_original_redirection_reason(
							msg, param, res);
			}
			break;
		...
		char *_called_status, char *_called_category, char *_e2e_indicator)
{
	...
	int res = isup_update_bci_1(&mangle, charge_indicator, called_status,
			called_category, e2e_indicator, (unsigned char *)body.s, body.len);
	if(res < 0) {
 ...
 *
 */
static int ki_set_bci_1(sip_msg_t *msg, char *_charge_indicator,
		char *_called_status, char *_called_category, char *_e2e_indicator)
{
	return (sipt_set_bci_1(msg, _charge_indicator, _called_status, _called_category, _e2e_indicator) == 1) ? SR_KEMI_TRUE : SR_KEMI_FALSE;
}
 ...
 *
 */
static int ki_destination(sip_msg_t *msg, char *_destination, char *_hops, char *_nai)
{
	return (sipt_destination(msg, _destination, _hops, _nai) == 1) ? SR_KEMI_TRUE : SR_KEMI_FALSE;
}
		...
		char *_hops, char *_nai, char *_terminator)
{
	...
	int res = isup_update_destination(
			&mangle, digits, hops, int_nai, (unsigned char *)body.s, body.len);
	free(digits);
	if(res < 0) {
...
static int ki_destination_terminator(sip_msg_t *msg, char *_destination, char *_hops, char *_nai,  char *_terminator)
{
	return (sipt_destination2(msg, _destination, _hops, _nai, _terminator) == 1) ? SR_KEMI_TRUE : SR_KEMI_FALSE;
}
		...
		char *_pres, char *_screen)
{
	...
	int res = isup_update_calling(&mangle, digits, int_nai, pres, screen,
			(unsigned char *)body.s, body.len);
	free(digits);
	if(res < 0) {
		LM_DBG("error updating IAM\n");
 ...
 *
 */
static int ki_set_calling(sip_msg_t *msg, char *_origin, char *_nai,
		char *_pres, char *_screen)
{
	return (sipt_set_calling(msg, _origin, _nai, _pres, _screen) == 1) ? SR_KEMI_TRUE : SR_KEMI_FALSE;
}
...
static int sipt_forwarding(struct sip_msg *msg, char *_fwdnumber, char *_nai)
{
	...
	int res = isup_update_forwarding(
			&mangle, digits, int_nai, (unsigned char *)body.s, body.len);
	free(digits);
	if(res < 0) {
		LM_DBG("error updating IAM\n");
		return -1;
 ...
 *
 */
static int ki_forwarding(sip_msg_t *msg, char *_fwdnumber, char *_nai)
{
	return (sipt_forwarding(msg, _fwdnumber, _nai) == 1) ? SR_KEMI_TRUE : SR_KEMI_FALSE;
}
...
static sr_kemi_t sr_kemi_sipt_exports[] = {
		{ str_init("sipt"), str_init("destination"), SR_KEMIP_BOOL, ki_destination,
				{ SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE }},
		{ str_init("sipt"), str_init("destination_terminator"), SR_KEMIP_BOOL, ki_destination_terminator,
				{ SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_STR,
						SR_KEMIP_NONE, SR_KEMIP_NONE }},
{ str_init("sipt"), str_init("forwarding"), SR_KEMIP_BOOL, ki_forwarding,
		{ SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE,
				SR_KEMIP_NONE, SR_KEMIP_NONE }},
{ str_init("sipt"), str_init("has_isup_body"), SR_KEMIP_BOOL, ki_has_isup_body,
	{ SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
SR_KEMIP_NONE, SR_KEMIP_NONE }},
{ str_init("sipt"), str_init("set_bci_1"), SR_KEMIP_BOOL, ki_set_bci_1,
	{ SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_STR,
SR_KEMIP_NONE, SR_KEMIP_NONE }},
{ str_init("sipt"), str_init("set_calling"), SR_KEMIP_BOOL, ki_set_calling,
	{ SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_STR,
SR_KEMIP_NONE, SR_KEMIP_NONE }},
